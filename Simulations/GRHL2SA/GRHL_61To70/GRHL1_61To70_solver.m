...
prs_file = 'GRHL1_61To70.prs';
prs_new = 'GRHL1_61To70.dat';
...
par_file = 'GRHL1_61To70_parameters.dat';
parameters = table2array(readtable(par_file));
parameters =  parameters(:, 3:end);
initFile = 'GRHL1_61To70_parameters_eqval.dat';
fid = fopen(initFile);
initConds = strings;
tline = fgetl(fid);
while ischar(tline)
...
parfor i = 1:size(parameters,1)
    ...
    for j = 1:l
        ...
        [t y] = ode23s(@(t,y)GRHL1_61To70(t,y,p), tspan, y0);
...
writetable(ss_tot, 'GRHL1_61To70_ss.csv');
